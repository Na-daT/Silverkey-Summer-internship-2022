...
namespace recipeDatabase.EntityClasses
{
	...
	
	{
		...
		protected class InstructionEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("InstructionEntity", InheritanceHierarchyType.None, false, (int)recipeDatabase.EntityType.InstructionEntity, typeof(InstructionEntity), typeof(InstructionEntityFactory), false);
				AddNavigatorMetaData<InstructionEntity, RecipeEntity>("Recipe", "Instructions", (a, b) => a._recipe = b, a => a._recipe, (a, b) => a.Recipe = b, recipeDatabase.RelationClasses.StaticInstructionRelations.RecipeEntityUsingRecipeIdStatic, ()=>new InstructionRelations().RecipeEntityUsingRecipeId, null, new int[] { (int)InstructionFieldIndex.RecipeId }, null, true, (int)recipeDatabase.EntityType.RecipeEntity);
			}
		}
		...
		public InstructionEntity(System.Int32 id) : this(id, null)
		{
		}
		...
		/// <param name="id">PK value for Instruction which data should be fetched into this Instruction object</param>
		/// <param name="validator">The custom validator object for this InstructionEntity</param>
		public InstructionEntity(System.Int32 id, IValidator validator)
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		/// <remarks>Mapped on  table field: "instruction"."id".<br/>Table field type characteristics (type, precision, scale, length): Integer, 10, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int32 Id
		{
			get { return (System.Int32)GetValue((int)InstructionFieldIndex.Id, true); }
			set { SetValue((int)InstructionFieldIndex.Id, value); }		}

		/// <summary>The IsActive property of the Entity Instruction<br/><br/></summary>
		/// <remarks>Mapped on  table field: "instruction"."is_active".<br/>Table field type characteristics (type, precision, scale, length): Boolean, 0, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		...
		/// <summary>The Name property of the Entity Instruction<br/><br/></summary>
		/// <remarks>Mapped on  table field: "instruction"."name".<br/>Table field type characteristics (type, precision, scale, length): Varchar, 0, 0, 1000.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Name
		{
			get { return (System.String)GetValue((int)InstructionFieldIndex.Name, true); }
			set	{ SetValue((int)InstructionFieldIndex.Name, value); }
		}

		/// <summary>The RecipeId property of the Entity Instruction<br/><br/></summary>
		/// <remarks>Mapped on  table field: "instruction"."recipe_id".<br/>Table field type characteristics (type, precision, scale, length): Integer, 10, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int32 RecipeId
		{
			get { return (System.Int32)GetValue((int)InstructionFieldIndex.RecipeId, true); }
