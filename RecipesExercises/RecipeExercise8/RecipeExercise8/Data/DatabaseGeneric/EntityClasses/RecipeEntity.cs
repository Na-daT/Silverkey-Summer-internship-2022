...
namespace recipeDatabase.EntityClasses
{
	...
	
	{
		...
		protected class RecipeEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("RecipeEntity", InheritanceHierarchyType.None, false, (int)recipeDatabase.EntityType.RecipeEntity, typeof(RecipeEntity), typeof(RecipeEntityFactory), false);
				AddNavigatorMetaData<RecipeEntity, EntityCollection<IngredientEntity>>("Ingredients", a => a._ingredients, (a, b) => a._ingredients = b, a => a.Ingredients, () => new RecipeRelations().IngredientEntityUsingRecipeId, typeof(IngredientEntity), (int)recipeDatabase.EntityType.IngredientEntity);
				AddNavigatorMetaData<RecipeEntity, EntityCollection<InstructionEntity>>("Instructions", a => a._instructions, (a, b) => a._instructions = b, a => a.Instructions, () => new RecipeRelations().InstructionEntityUsingRecipeId, typeof(InstructionEntity), (int)recipeDatabase.EntityType.InstructionEntity);
				AddNavigatorMetaData<RecipeEntity, EntityCollection<RecipeCategoryEntity>>("RecipeCategories", a => a._recipeCategories, (a, b) => a._recipeCategories = b, a => a.RecipeCategories, () => new RecipeRelations().RecipeCategoryEntityUsingRecipeId, typeof(RecipeCategoryEntity), (int)recipeDatabase.EntityType.RecipeCategoryEntity);
			}
		}
		...
		public RecipeEntity(System.Int32 id) : this(id, null)
		{
		}
		...
		/// <param name="id">PK value for Recipe which data should be fetched into this Recipe object</param>
		/// <param name="validator">The custom validator object for this RecipeEntity</param>
		public RecipeEntity(System.Int32 id, IValidator validator)
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		/// <remarks>Mapped on  table field: "recipe"."id".<br/>Table field type characteristics (type, precision, scale, length): Integer, 10, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int32 Id
		{
			get { return (System.Int32)GetValue((int)RecipeFieldIndex.Id, true); }
		...
		/// <remarks>Mapped on  table field: "recipe"."title".<br/>Table field type characteristics (type, precision, scale, length): Varchar, 0, 0, 100.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
