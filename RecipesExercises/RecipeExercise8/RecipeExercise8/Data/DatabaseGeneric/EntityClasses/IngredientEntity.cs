...
namespace recipeDatabase.EntityClasses
{
	...
	
	{
		...
		protected class IngredientEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("IngredientEntity", InheritanceHierarchyType.None, false, (int)recipeDatabase.EntityType.IngredientEntity, typeof(IngredientEntity), typeof(IngredientEntityFactory), false);
				AddNavigatorMetaData<IngredientEntity, RecipeEntity>("Recipe", "Ingredients", (a, b) => a._recipe = b, a => a._recipe, (a, b) => a.Recipe = b, recipeDatabase.RelationClasses.StaticIngredientRelations.RecipeEntityUsingRecipeIdStatic, ()=>new IngredientRelations().RecipeEntityUsingRecipeId, null, new int[] { (int)IngredientFieldIndex.RecipeId }, null, true, (int)recipeDatabase.EntityType.RecipeEntity);
			}
		}
		...
		public IngredientEntity(System.Int32 id) : this(id, null)
		{
		}
		...
		/// <param name="id">PK value for Ingredient which data should be fetched into this Ingredient object</param>
		/// <param name="validator">The custom validator object for this IngredientEntity</param>
		public IngredientEntity(System.Int32 id, IValidator validator)
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		/// <remarks>Mapped on  table field: "ingredient"."id".<br/>Table field type characteristics (type, precision, scale, length): Integer, 10, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int32 Id
		{
			get { return (System.Int32)GetValue((int)IngredientFieldIndex.Id, true); }
			set { SetValue((int)IngredientFieldIndex.Id, value); }		}

		/// <summary>The IsActive property of the Entity Ingredient<br/><br/></summary>
		/// <remarks>Mapped on  table field: "ingredient"."is_active".<br/>Table field type characteristics (type, precision, scale, length): Boolean, 0, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		...
		/// <remarks>Mapped on  table field: "ingredient"."name".<br/>Table field type characteristics (type, precision, scale, length): Varchar, 0, 0, 1000.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		...
		/// <remarks>Mapped on  table field: "ingredient"."recipe_id".<br/>Table field type characteristics (type, precision, scale, length): Integer, 10, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
