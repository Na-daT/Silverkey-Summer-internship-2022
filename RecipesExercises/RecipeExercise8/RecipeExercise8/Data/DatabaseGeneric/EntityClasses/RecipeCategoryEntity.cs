...
namespace recipeDatabase.EntityClasses
{
	...
	
	{
		...
		protected class RecipeCategoryEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("RecipeCategoryEntity", InheritanceHierarchyType.None, false, (int)recipeDatabase.EntityType.RecipeCategoryEntity, typeof(RecipeCategoryEntity), typeof(RecipeCategoryEntityFactory), false);
				AddNavigatorMetaData<RecipeCategoryEntity, CategoryEntity>("Category", "RecipeCategories", (a, b) => a._category = b, a => a._category, (a, b) => a.Category = b, recipeDatabase.RelationClasses.StaticRecipeCategoryRelations.CategoryEntityUsingCategoryIdStatic, ()=>new RecipeCategoryRelations().CategoryEntityUsingCategoryId, null, new int[] { (int)RecipeCategoryFieldIndex.CategoryId }, null, true, (int)recipeDatabase.EntityType.CategoryEntity);
				AddNavigatorMetaData<RecipeCategoryEntity, RecipeEntity>("Recipe", "RecipeCategories", (a, b) => a._recipe = b, a => a._recipe, (a, b) => a.Recipe = b, recipeDatabase.RelationClasses.StaticRecipeCategoryRelations.RecipeEntityUsingRecipeIdStatic, ()=>new RecipeCategoryRelations().RecipeEntityUsingRecipeId, null, new int[] { (int)RecipeCategoryFieldIndex.RecipeId }, null, true, (int)recipeDatabase.EntityType.RecipeEntity);
			}
		}
		...
		/// <remarks>Mapped on  table field: "recipe_category"."category_id".<br/>Table field type characteristics (type, precision, scale, length): Integer, 10, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int32 CategoryId
		{
			get { return (System.Int32)GetValue((int)RecipeCategoryFieldIndex.CategoryId, true); }
		...
		/// <remarks>Mapped on  table field: "recipe_category"."id".<br/>Table field type characteristics (type, precision, scale, length): Integer, 10, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		...
		/// <remarks>Mapped on  table field: "recipe_category"."is_active".<br/>Table field type characteristics (type, precision, scale, length): Boolean, 0, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		...
		/// <remarks>Mapped on  table field: "recipe_category"."recipe_id".<br/>Table field type characteristics (type, precision, scale, length): Integer, 10, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int32 RecipeId
		{
			get { return (System.Int32)GetValue((int)RecipeCategoryFieldIndex.RecipeId, true); }
...
namespace recipeDatabase.RelationClasses
{
