...
namespace recipeDatabase.EntityClasses
{
	...
	
	{
		...
		protected class UserEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("UserEntity", InheritanceHierarchyType.None, false, (int)recipeDatabase.EntityType.UserEntity, typeof(UserEntity), typeof(UserEntityFactory), false);
			}
		}
		...
		/// <remarks>Mapped on  table field: "user"."password".<br/>Table field type characteristics (type, precision, scale, length): Varchar, 0, 0, 100.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		...
		/// <summary>The RefreshTokenExpiry property of the Entity User<br/><br/></summary>
		/// <remarks>Mapped on  table field: "user"."refresh_token_expiry".<br/>Table field type characteristics (type, precision, scale, length): Timestamp, 0, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.DateTime> RefreshTokenExpiry
		{
			get { return (Nullable<System.DateTime>)GetValue((int)UserFieldIndex.RefreshTokenExpiry, false); }
			set	{ SetValue((int)UserFieldIndex.RefreshTokenExpiry, value); }
		}

		/// <summary>The Username property of the Entity User<br/><br/></summary>
		/// <remarks>Mapped on  table field: "user"."username".<br/>Table field type characteristics (type, precision, scale, length): Varchar, 0, 0, 100.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
...
namespace recipeDatabase
{
	public enum UserFieldIndex
	{
		...
		RefreshToken,
		///<summary>RefreshTokenExpiry. </summary>
		RefreshTokenExpiry,
