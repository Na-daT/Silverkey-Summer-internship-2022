...
namespace recipeDatabase.FactoryClasses
{
		...
		where TEntity : EntityBase2, IEntity2
	{
		...
		public EntityFactoryBase2(string entityName, recipeDatabase.EntityType typeOfEntity, bool isInHierarchy) : base(entityName, (int)typeOfEntity)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((recipeDatabase.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public CategoryEntityFactory() : base("CategoryEntity", recipeDatabase.EntityType.CategoryEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public IngredientEntityFactory() : base("IngredientEntity", recipeDatabase.EntityType.IngredientEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public InstructionEntityFactory() : base("InstructionEntity", recipeDatabase.EntityType.InstructionEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public RecipeEntityFactory() : base("RecipeEntity", recipeDatabase.EntityType.RecipeEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public RecipeCategoryEntityFactory() : base("RecipeCategoryEntity", recipeDatabase.EntityType.RecipeCategoryEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public UserEntityFactory() : base("UserEntity", recipeDatabase.EntityType.UserEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public VersionInfoEntityFactory() : base("VersionInfoEntity", recipeDatabase.EntityType.VersionInfoEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(recipeDatabase.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(recipeDatabase.EntityType)))
			{
				var factory = GetFactory((recipeDatabase.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the recipeDatabase.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(recipeDatabase.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case recipeDatabase.EntityType.CategoryEntity:
					return new CategoryEntityFactory();
				case recipeDatabase.EntityType.IngredientEntity:
					return new IngredientEntityFactory();
				case recipeDatabase.EntityType.InstructionEntity:
					return new InstructionEntityFactory();
				case recipeDatabase.EntityType.RecipeEntity:
					return new RecipeEntityFactory();
				case recipeDatabase.EntityType.RecipeCategoryEntity:
					return new RecipeCategoryEntityFactory();
				case recipeDatabase.EntityType.UserEntity:
					return new UserEntityFactory();
				case recipeDatabase.EntityType.VersionInfoEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the recipeDatabase.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (recipeDatabase.EntityType)Enum.Parse(typeof(recipeDatabase.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((recipeDatabase.EntityType)Enum.Parse(typeof(recipeDatabase.EntityType), leftOperandEntityName, false), joinType, (recipeDatabase.EntityType)Enum.Parse(typeof(recipeDatabase.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (recipeDatabase.EntityType)Enum.Parse(typeof(recipeDatabase.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((recipeDatabase.EntityType)entityTypeValue); }
